...
export default function Home() {
  ...
  const roomType = [
    ...
    },
    {
      ...
      // availability: 2,
      price: "48,900",
      description: "Enjoy peaceful moments by the fire in this cabin ideal for romantic getaways."
    },
    {
      name: "Matheran",
      img: cozyCabin3,
    ...
    },
    {
      ...
      // availability: 5,
      price: "29,000",
      description: "Step into elegance with a private patio perfect for relaxation and morning coffee."
    },
    {
      name: "Matheran",
      img: gardenView1,
    ...
    {facilities.map((facility, index) => (
      ...
      >
        ...
        <div className="m-5 mt-12 p-3">
          <div className="my-6">
            <h1 className="text-4xl font-bold"><strong className="text-primary">Discover</strong> Villa's</h1>
          </div>
  ...
  />
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-primary text-xl font-semibold mb-4">{selectedRoom.price} / 24 Hour</p>
