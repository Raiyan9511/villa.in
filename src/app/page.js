  ...
  const features = [
    {
      ...
      bg: "bg-primary/20",
      icon: <MdEco size={28} className="text-secondary/40" />,
    },
    {
      title: "Personalized services",
      bg: "bg-primary/30",
      icon: <FaHandsHelping size={28} className="text-secondary/50" />,
    },
    {
      title: "Best price guarantee",
      bg: "bg-primary/40",
      icon: <FaTag size={28} className="text-secondary/65" />,
    },
    {
      title: "Prime location",
      bg: "bg-primary/50",
      icon: <MdLocationOn size={28} className="text-secondary/80" />,
    },
  ];
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <motion.section
        ...
        viewport={{ once: true, amount: 0.2 }}
        variants={{
          hidden: { opacity: 0, y: -50 }, // changed 50 to -50 to make it come from top
          visible: {
            opacity: 1,
            y: 0,
            transition: {
              ...
              >
                <div className="relative w-full h-64 overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col justify-center items-center text-white p-4 text-center">
                    <p className="text-sm mb-2">{room.name} Villa</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="relative h-64 lg:h-full">
                    <RoomImageSlider
                      images={[
                        selectedRoom.img,
                        selectedRoom.img2,
                        selectedRoom.img3, // yaha jitne images ho unko add karo
                      ]}
                    />
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-8">
                      <a href="/booking">
                        <button className="flex-1 bg-primary text-white py-3 px-6 rounded-lg hover:bg-primary/90 transition-colors font-medium">
                          Book Now
                        </button>
                      </a>
                      <a href="/contact">
                        <button className="flex-1 border border-primary text-primary py-3 px-6 rounded-lg hover:bg-primary/10 transition-colors font-medium">
                          Contact Us
                        </button>
                      </a>
                    </div>
      ...
      >
        ...
        <div className="flex flex-col gap-3">
          {features.map((feature, index) => (
            ...
            >
              <div
                className={`${feature.bg} p-6 rounded-full shadow-md flex items-center gap-4`}
              >
                {feature.icon}
