...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappNumber = '919029511259'; // Apna WhatsApp number with country code (91) likho
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Bhiwandi,Thane, Maharastra. </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@Villa.com</p>
    ...
    <div className="flex">
      ...
      <div>
        <p className="text-sm text-blue-800">
          <strong>24/7 Support:</strong> While our office has specific hours, our customer support team is available round the clock at +91 85549 90746 for urgent matters.
        </p>
      </div>
    </div>
  </div>
